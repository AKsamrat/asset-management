      ...
      <section className="py-20 dark:bg-gray-100 dark:text-gray-800">
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-16 text-center">
            ...
            <h2 className="text-4xl font-bold lg:text-5xl mt-4">
              Choose your best <span className="text-[#FEBF32]">Package</span>
            </h2>
          </div>
            ...
            >
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-50">
                ...
                <p className="mt-3 leading-relaxed dark:text-gray-600">
                  Grave your basic Plan for your business
                </p>
                <ul className="flex-1 mb-6 dark:text-gray-600">
                  <li className="flex items-center space-x-2">
                    ...
                    <span>Other Functionality is Free</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>5 Employee can access</span>
                  </li>
                </ul>
                <Link
                  // to={`/payment/${5}`}
            ...
            >
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-600 dark:text-gray-50">
                ...
                <p className="leading-relaxed">
                  Grave your standart Package for your business
                </p>
                <ul className="flex-1 space-y-2">
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span>10 Employee can access</span>
                  </li>
                </ul>
                <Link
                  to={`/payment/${8}`}
            ...
            >
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-50">
                ...
                <p className="leading-relaxed dark:text-gray-600">
                  Grave your Premium Package for your business
                </p>
                <ul className="space-y-2 dark:text-gray-600">
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span>20 Employee can access</span>
                  </li>
                </ul>
                <Link
                  to={`/payment/${15}`}
