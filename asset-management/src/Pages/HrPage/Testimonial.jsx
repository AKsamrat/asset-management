        ...
        <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
          <div className="flex flex-col items-center mx-12 lg:mx-0">
            <div className="relative text-center">
              ...
              <p className="px-6 py-1 text-lg italic">
                I wish I'd read the reviews before I placed an order over a
                month ago. Not able to track item and when I initially contacted
                them via email I was told to be patient.
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
          ...
          <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
            <div className="relative text-center">
              ...
              <p className="px-6 py-1 text-lg italic">
                I was unable to track and every time I queried they reassured me
                that they would fix the tracking. 2 months later and numerous
                emails I complained to Pay Pal who contacted the company and
                they advised it had been delivered.
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
